...
- [pbakaus/impeccable](https://github.com/pbakaus/impeccable): detector lineage, craft-floor, modes doctrine. Apache-2.0 licensed. The 11 slop specimens under `scripts/fixtures/specimens/` are copied from impeccable's antipattern-examples (https://impeccable.style/slop/), Apache-2.0.
