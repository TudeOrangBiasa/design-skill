...
STATUS 2026-08-13: coverage audit below audits the v1 skill (26-rule detector era); the v2 detector is 53 rules (46 + kpi-monument, justified-text, tight-line-height, tiny-body-text, wide-body-tracking, repeating-gradient-stripes, skipped-heading-level) - see research/impeccable-slop.md for the current coverage audit. Historical record.
